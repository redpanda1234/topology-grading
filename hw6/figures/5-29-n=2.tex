...
\begin{document}
  \begin{tikzpicture}[use Hobby shortcut]
    ...
    \draw[densely dotted, pattern=north east lines, pattern color=red] (-1.5,6) rectangle (4, 4);
    \draw[densely dotted, pattern=north west lines, pattern color=blue] (8,4.7) rectangle (3, 2.8);
    \node (U1) at (1.5,6.3) {\Large \color{red} $U_1$};
    \node (V1) at (5.5,5) {\Large \color{blue} $V_1$};
